...
public interface ISort<T extends Comparable<T>> {
	/**
	 * Sorts the given collection of elements using heap-sort algorithm
	 * in-place, and returns a clone of the complete heap that you constructed
	 * during the sorting, and before you empty it. Runs in O(n lg n) time
	 * 
	 * @param unordered
	 *            unordered elements

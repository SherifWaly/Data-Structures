...
public interface IGraph { 
	 ...
	 * * space. i,j represents the nodes that are connected through this edge (0 <= i, j < V) * and w determines the weight on this edge. Weights may be negative or positive. 
